/*
 * DIRECTIVE-PD3 P3 (S54) — the campaign week derivation, pinned fast.
 */
import { campaignWeek } from './campaign-clock';

describe('campaignWeek — DIRECTIVE-PD3 P3 (S54): the header WK off the one clock', () => {
    ...
    it('a missing start or current date reads week 1 (the pre-D-022 fallback), never NaN', () => {
