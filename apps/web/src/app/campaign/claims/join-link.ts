...
export function playerJoinUrl(campaignId: string | null): string {
    let u: URL;
    try { u = new URL(playerBaseUrl()); } catch { return playerBaseUrl(); }
...
export class JoinLinkComponent {
    ...
    protected readonly joinUrl = computed(() => playerJoinUrl(this.store.campaignId()));
