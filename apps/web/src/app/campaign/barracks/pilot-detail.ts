...
import { CampaignPilotCardComponent } from '../chaos/campaign-pilot-card';
...
@Component({
    ...
    imports: [CampaignPilotCardComponent],
...
export class PilotDetailComponent {
    ...
    protected saveNotes(): void {
        ...
        if (d === null) return;
        if (this.notesText() !== null) { this.notesSaved.emit(d.trim()); this.notesDraft.set(null); return; }
