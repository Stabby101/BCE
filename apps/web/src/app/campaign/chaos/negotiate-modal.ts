...
@Component({
    ...
    styles: [`
        ...
        .cng-overlay { position:fixed; inset:0; background:rgba(20,16,10,.55); display:flex; align-items:flex-start; justify-content:center; padding:40px 16px calc(40px + var(--bce-footer-h, 0px)); overflow-y:auto; overscroll-behavior:contain; z-index:60; }
        ...
        .cng-scale-auth { display:block; font-family:var(--mono); font-size:10.5px; letter-spacing:.4px; color:var(--ink2); margin-top:4px; }
        .cng-scale-auth.dev { color:var(--stamp); }
        .cpv-overlay { position:fixed; inset:0; background:rgba(20,16,10,.55); display:flex; align-items:flex-start; justify-content:center; padding:40px 16px calc(40px + var(--bce-footer-h, 0px)); overflow-y:auto; z-index:60; }
